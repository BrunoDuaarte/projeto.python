...
def gerar_pdf(df):
	...
	pdf.setTitle("Dados de Ações - Bruno")
	pdf.drawString(100, 750, "Dados de Ações Fitradas")
...
def gerar_json(dados):
    df = pd.DataFrame(dados)  # Ajuste conforme seu formato de dados
...
st.sidebar.download_button(
	...
	data=excel_bytes,
	file_name="filtro_acoes_bruno.xlsx",
	mime="application/vnd.openxmlformats-officedocument.srpreadsheetml.sheet"
)
